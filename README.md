...
Both models are trained using a 12-period sliding window to predict a one-step-ahead forecast. Model weights are updated after each batch of 64 samples. This process is repeated for 60 epochs.
